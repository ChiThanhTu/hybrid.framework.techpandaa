...
//		String screenshotPath = captureScreenshotAsFile(driver, result.getName());
		String screenshotPath = captureScreenshotAsBase64(driver, result.getName());
...
//		Reporter.log("<br><a target=\"_blank\" href=\"file:///" + screenshotPath + "\">" + "<img src=\"file:///" + screenshotPath + "\" " + "height='100' width='150'/> " + "</a></br>");
	...
	public String captureScreenshotAsFile(WebDriver driver, String screenshotName) {
		try {
			...
			String screenPath = GlobalConstants.getGlobalConstants().getReportScreenPath() + "_" + formater.format(calendar.getTime()) + ".png";
