...
public static final String CONTINUE_BILLING_INFORMATION_BUTTON="XPATH=//button[@onclick='billing.save()']//span[text()='Continue']";
public static final String CONTINUE_SHIPPING_METHOD_BUTTON="XPATH=//button[@onclick='shippingMethod.save()']//span[text()='Continue']";
public static final String CONTINUE_PAYMENT_INFORMATION_BUTTON="XPATH=//button[@onclick='payment.save()']//span[text()='Continue']";
