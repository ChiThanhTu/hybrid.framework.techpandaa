...
public class Admin extends BaseTest {
	...
	static String userName, password,email,ID,telephone,zip,country,stateProvince,customerSince,name;
	...
	public void TC_02_Login_With_Invalid_User_Password(Method method) {
		...
		ExtentManager.getTest().log(Status.INFO, "TC_02 - Step 01: Enter To Valid User");
		adminLoginPage.InputDynamicTextboxByID("username","user055");
		ExtentManager.getTest().log(Status.INFO, "TC_02 - Step 02: Enter To Valid Password");
		adminLoginPage.InputDynamicTextboxByID("login","guru999");
	...
	public void TC_03_Login_With_Valid_User_Password(Method method) {
		...
		ExtentManager.getTest().log(Status.INFO, "TC_03 - Step 01: Enter To Valid User");
		adminLoginPage.InputDynamicTextboxByID("username",userName);
		ExtentManager.getTest().log(Status.INFO, "TC_03 - Step 02: Enter To Valid Password");
	...
	public void TC_04_Search_With_Emty_All_Of_Customer(Method method) {
		ExtentManager.startTest(method.getName(), "TC 04 Inalid User Password");
		...
		ExtentManager.getTest().log(Status.INFO, "TC_04 - Step assert: Verify Customer In For Displayed");
		verifyTrue(adminManageCustomerPage.isCustomerInforDislayed());
	}
//	@Test
//	public void TC_04_Search_With_Invalid_Email_Of_Customer(Method method) {
//		ExtentManager.startTest(method.getName(), "TC 04 Inalid User Password");
//		ExtentManager.getTest().log(Status.INFO, "TC_04 - Step 01: Enter To Invalid Email");
//		adminManageCustomerPage.inputToTextboxByHeaderName("Email","customerGrid_filter_email","tuem11111@gmail.com");
//		ExtentManager.getTest().log(Status.INFO, "TC_04 - Step assert: Verify No records found Message");
//		verifyEquals(adminManageCustomerPage.getNoRecordsFoundMessage(), "No records found.");
//	}
//	@Test
//	public void TC_05_Search_With_Valid_Email_Of_Customer(Method method) {
//		ExtentManager.startTest(method.getName(), "TC 05 Valid User Password");
//		ExtentManager.getTest().log(Status.INFO, "TC_05 - Step 01: Enter To valid Email");
//		adminManageCustomerPage.inputToTextboxByHeaderName("Email","customerGrid_filter_email",email);
//		ExtentManager.getTest().log(Status.INFO, "TC_05 - Step assert: Verify Valid Email Information ");
...
//	}
//	@Test
//	public void TC_06_Search_With_Valid_Bill_To_Name_Of_Orders(Method method) {
//		ExtentManager.startTest(method.getName(), "TC 06 Valid Bill To Name Of Orders");
//		ExtentManager.getTest().log(Status.INFO, "TC_06 - Step 01: Click To Order Link");
//		adminOrderPage= adminManageCustomerPage.getHeaderContainerPage(driver).OpenAdminSalesOrderPage("Sales","Orders");
//		ExtentManager.getTest().log(Status.INFO, "TC_06 - Step 02: Input To valid Bill to Name of orders");
//		adminOrderPage.inputToTextboxByHeaderName("Bill to Name","sales_order_grid_filter_billing_name",name);
//		ExtentManager.getTest().log(Status.INFO, "TC_06 - Step assert: Verify Order Information");
//		verifyEquals(adminOrderPage.getTextByHeaderNameAndRowNummer("Bill to Name","3"), "Tú Chi thanh Chi");
//		verifyEquals(adminOrderPage.getTextByHeaderNameAndRowNummer("Ship to Name","3"), "Tú Chi thanh Chi");
//		verifyEquals(adminOrderPage.getTextByHeaderNameAndRowNummer("Order #","3"), "100017892");
//		verifyEquals(adminOrderPage.getTextByHeaderNameAndRowNummer("Purchased On","3"), "Feb 8, 2023 6:23:42 AM");
//		verifyEquals(adminOrderPage.getTextByHeaderNameAndRowNummer("G.T. (Purchased)","3"), "$705.00");
//		verifyEquals(adminOrderPage.getTextByHeaderNameAndRowNummer("G.T. (Base)","3"), "$705.00");
//
//	}
//	@Test
//	public void TC_07_Search_With_Invalid_Bill_To_Name_Of_Orders(Method method) {
//		ExtentManager.startTest(method.getName(), "TC 07 Invalid Bill To Name Of Orders");
//		ExtentManager.getTest().log(Status.INFO, "TC_07 - Step 01: Click To Order Link");
//		adminOrderPage= adminManageCustomerPage.getHeaderContainerPage(driver).OpenAdminSalesOrderPage("Sales","Orders");
//		ExtentManager.getTest().log(Status.INFO, "TC_07 - Step 02: Input To Invalid Bill to Name of orders");
//		adminOrderPage.inputToTextboxByHeaderName("Bill to Name","sales_order_grid_filter_billing_name","khong co");
//		ExtentManager.getTest().log(Status.INFO, "TC_07 - Step assert: Verify Order Information");
//		verifyEquals(adminOrderPage.getNoRecordsFoundMessage(), "No records found.");
//	}
//	@Test
//	public void TC_08_Search_With_Invalid_Nick_Name_Of_All_Reviews(Method method) {
//		ExtentManager.startTest(method.getName(), "TC 07 Invalid Nick Name Of All Reviews");
//		ExtentManager.getTest().log(Status.INFO, "TC_07 - Step 01: Click To All Reciews Link");
...
//		adminAllReviewsPage.inputToTextboxByHeaderName("Nickname","reviwGrid_filter_nickname","khong co");
//		ExtentManager.getTest().log(Status.INFO, "TC_07 - Step assert: Verify All Rieviews Information");
//		verifyEquals(adminAllReviewsPage.getNoRecordsFoundMessage(), "No records found.");
//	}
//	@Test
//	public void TC_08_Search_With_Valid_Nick_Name_Of_All_Reviews(Method method) {
//		ExtentManager.startTest(method.getName(), "TC 07 Invalid Nick Name Of All Reviews");
//		ExtentManager.getTest().log(Status.INFO, "TC_07 - Step 01: Click To All Reciews Link");
//		adminAllReviewsPage=adminOrderPage.getHeaderContainerPage(driver).OpenAdminAllReviewsPage("Catalog", "Reviews and Ratings", "Customer Reviews", "All Reviews");
//		adminAllReviewsPage.inputToTextboxByHeaderName("Nickname","reviwGrid_filter_nickname","Cuong");
//		ExtentManager.getTest().log(Status.INFO, "TC_07 - Step assert: Verify All Rieviews Information");
